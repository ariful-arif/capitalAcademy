...
@push('title', get_phrase('Add Learning Resources'))
@push('meta')@endpush
@push('css')
        ...
        <div class="col-md-8">
            <div class="ol-card p-4">
                <div class="ol-card-body">
                    <form action="{{ route('admin.learning.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="fpb-7 mb-3">
                            <label class="form-label ol-form-label" for="title">{{ get_phrase('Title') }}</label>
                            <input type="text" class="form-control ol-form-control" name="title" id="title"
                                placeholder="{{ get_phrase('Enter learning title') }}" required>
                        </div>
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="form-control ol-form-control ol-select2" data-toggle="select2" name="category_id"
                                id="learning_category_id" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 fpb-7">
                                ...
                                <div class="image_preview">
                                    <img src="{{ get_image() }}" id="preview_banner" alt="learning-banner">
                                </div>
                            ...
                            <div class="col-md-6 fpb-7 ">
                                ...
                                <div class="image_preview">
                                    <img src="{{ get_image() }}" id="preview_thumbnail" alt="learning-thumbnail">
                                </div>
                        ...
                        <div class="fpb-7 mb-3">
                            <button type="submit" class="ol-btn-primary">{{ get_phrase('Add learning') }}</button>
                        </div>
                    </form>
                </div>
            </div>
