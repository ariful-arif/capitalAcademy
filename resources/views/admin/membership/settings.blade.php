...
@push('title', get_phrase('Membership Page'))
@section('content')
        ...
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                <h4 class="title fs-16px">
                    ...
                    {{ get_phrase('Manage Subscription Page') }}
                </h4>

                <a
                    href="{{ route('admin.membership.package_create') }}"class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                    <span class="fi-rr-plus"></span>
                    <span>{{ get_phrase('Add New Pacakge') }}</span>
                </a>
            </div>
        </div>
    </div>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.membership.package_edit', ['id' => $row->id]) }}">{{ get_phrase('Edit Package') }}</a>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        onclick="confirmModal('{{ route('admin.membership.package_delete', $row->id) }}')"
