                    ...
                    <form action="{{ route('admin.course.bundle.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <textarea name="short_description" id="short_description" rows="4" class="form-control ol-form-control" placeholder="{{ get_phrase('Enter short description') }}"></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control ol-form-control ol-select2" name="bundle_category_id" id="bundle_category_id" required>
                                    ...
                                    @foreach (App\Models\Bundle_category::get() as $bundle_category)
                                        <option value="{{ $bundle_category->id }}">{{ $bundle_category->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="fpb-7 mb-3">
                           ...
                           <div class="fpb-7 mb-3">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="link" class="form-control ol-form-control" name="trailer_video_link" id="trailer_video_link" placeholder="http://youtube.com/watch?v=xxx" required>
                            </div>
