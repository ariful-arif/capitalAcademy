                    ...
                    <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                        <div class="ol-sidebar-tab">
                            <div class="d-flex flex-column">
                                ...
                                <a class="nav-link @if ($tab == 'certificate_program') active @endif"
                                    href="{{ route('admin.course.edit', [$param, 'tab' => 'certificate_program']) }}">
                                    <span class="fi-rr-comment-dollar"></span>
                                    <span>{{ get_phrase('Certificate Program') }}</span>
                                </a>
                        ...
                        <div class="tab-content w-100">
                            ...
                            @includeWhen($tab == 'certificate_program', 'admin.course.certificate_program')
