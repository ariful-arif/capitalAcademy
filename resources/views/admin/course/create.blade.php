                        ...
                        <div class="row">
                            <div class="col-md-6 pb-2">
                                <div class="eForm-layouts">
                                    ...
                                    {{-- <div class="row mb-3">
                                        <label
                                            class="form-label ol-form-label col-sm-3 col-form-label">{{ get_phrase('Certificate Course') }}<span
                                                class="text-danger ms-1">*</span></label>
                                        <div class="col-sm-6">
                                            <div class="eRadios">
                                                <div class="form-check">
                                                    <input type="radio" name="is_certificate_course" value="1"
                                                        class="form-check-input eRadioSuccess" id="paida"
                                                        onchange="$('#is_certificate_course').slideDown(200)">
                                                    <label for="Yes"
                                                        class="form-check-label">{{ get_phrase('Yes') }}</label>
                                                </div>

                                                <div class="form-check">
                                                    <input type="radio" name="is_certificate_course" value="0"
                                                        class="form-check-input eRadioSuccess" id="freea"
                                                        onchange="$('#is_certificate_course').slideUp(200)" checked>
                                                    <label for="No"
                                                        class="form-check-label">{{ get_phrase('No') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="is_certificate_course" id="is_certificate_course">
                                        <div class="row mb-3">
                                            <label
                                                class="form-label ol-form-label col-sm-3 col-form-label">{{ get_phrase('Certificate Course Type') }}<span
                                                    class="required text-danger">*</span></label>
                                            <div class="col-sm-6">
                                                <div class="eRadios">
                                                    <div class="form-check">
                                                        <input type="radio" id="core_course"
                                                            name="certificate_course_type"
                                                            class="form-check-input eRadioSuccess" value="core">
                                                        <label class="form-check-label"
                                                            for="core_course">{{ get_phrase('Core Course') }}</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" id="elective_course"
                                                            name="certificate_course_type"
                                                            class="form-check-input eRadioSuccess" value="elective">
                                                        <label class="form-check-label"
                                                            for="elective_course">{{ get_phrase('Elective Course') }}</label>
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="ol-select2 select2-hidden-accessible"
                                                    name="certificate_ids[]" multiple="multiple" required
                                                    data-placeholder="Select certificate program">
                                                    <option value="" disabled>
                                                        {{ get_phrase('Select certificate program') }}</option>
                                                    @foreach (App\Models\CertificateProgram::where('status', 'active')->where('user_id', auth()->user()->id)->orderBy('title', 'desc')->get() as $certificate)
                                    ...
                                    <div class="row mb-3">
                                        <label class="form-label ol-form-label col-sm-4 col-form-label">
                                            {{ get_phrase('Certificate Course') }}<span class="text-danger ms-1">*</span>
                                        </label>
                                        <div class="col-sm-6">
                                            <div class="eRadios row">
                                                <div class="form-check col-sm-4">
                                                    <input type="radio" name="is_certificate_course" value="1"
                                                        class="form-check-input eRadioSuccess" id="paida"
                                                        onchange="toggleCertificateOptions()"
                                                        {{ old('is_certificate_course') == '1' ? 'checked' : '' }}>
                                                    <label for="paida"
                                                        class="form-check-label">{{ get_phrase('Yes') }}</label>
                                                </div>
                                    ...
                                    <div class="is_certificate_course" id="is_certificate_course" style="display: none;">
                                        <div class="row mb-3">
                                            <label class="form-label ol-form-label col-sm-4 col-form-label">
                                                {{ get_phrase('Certificate Course Type') }}<span
                                                ...
                                                <div class="eRadios">
                                                    <div class="form-check">
                                                        <input type="radio" id="core_course"
                                                            name="certificate_course_type"
                                                            class="form-check-input eRadioSuccess" value="core"
                                                            {{ old('certificate_course_type') == 'core' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="core_course">{{ get_phrase('Core Course') }}</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" id="elective_course"
                                                            name="certificate_course_type"
                                                            class="form-check-input eRadioSuccess" value="elective"
                                                            {{ old('certificate_course_type') == 'elective' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="elective_course">{{ get_phrase('Elective Course') }}</label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="ol-select2 select2-hidden-accessible"
                                                    ...
                                                    @foreach (App\Models\CertificateProgram::where('status', 'active')->where('user_id', auth()->user()->id)->orderBy('title', 'desc')->get() as $certificate)
                                                        <option value="{{ $certificate->id }}"
                                                            {{ in_array($certificate->id, old('certificate_ids', [])) ? 'selected' : '' }}>
                                                            {{ $certificate->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
...
@push('js')
    <script>
        ...
        function toggleCertificateOptions() {
            var isChecked = document.querySelector('input[name="is_certificate_course"]:checked').value;
            var certificateSection = document.getElementById('is_certificate_course');
