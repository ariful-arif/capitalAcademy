...
<form action="{{ route('admin.dynamic_pages.settings.update') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="fpb-7 mb-3 col">
        ...
        @if (!empty($business_university_page_setting['thumbnail_video_1']))
            <img src="{{ asset($business_university_page_setting['thumbnail_video_1']) }}" alt="Thumbnail_video_1" class="img-fluid mb-3"
                style="width: 200px; height: 150px;">

            {{-- <video controls class="mb-2" style="width: 200px; height: 150px;">
                <source src="{{ asset($business_university_page_setting['thumbnail_video_1']) }}" type="video/mp4">
                {{ get_phrase('Your browser does not support the video tag.') }}
            </video> --}}
        @endif
