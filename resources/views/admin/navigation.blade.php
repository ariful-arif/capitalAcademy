...
<div class="sidebar-nav-area">
    <nav class="sidebar-nav">
        <ul class="px-14px pb-24px">
            ...
            @if (has_permission('admin.certificate_program'))
                <li class="sidebar-first-li first-li-have-sub @if (
                    $current_route == 'admin.certificate_program' ||
                        $current_route == 'admin.certificate_program.create' ||
                        $current_route == 'admin.certificate_program.edit') active showMenu @endif">
                    <a href="javascript:void(0);">
                        <span class="icon fi fi-rr-e-learning"></span>
                        <div class="text">
                    ...
                    <ul class="first-sub-menu">
                        <li class="first-sub-menu-title fs-14px mb-18px">{{ get_phrase('Certificate') }}</li>
                        <li class="sidebar-second-li @if ($current_route == 'admin.certificate_program' || $current_route == 'admin.certificate_program.edit') active @endif">
                            <a
                                href="{{ route('admin.certificate_program') }}">{{ get_phrase('Manage Certificate') }}</a>
                        </li>
                        <li class="sidebar-second-li @if ($current_route == 'admin.certificate_program.create') active @endif">
                            <a
                                href="{{ route('admin.certificate_program.create') }}">{{ get_phrase('Add New Certificate') }}</a>
                        </li>
                    </ul>
                </li>
            @endif

            @if (has_permission('admin.subscription_package'))
                <li
                    class="sidebar-first-li first-li-have-sub @if (
                        $current_route == 'admin.subscription_package' ||
                            $current_route == 'admin.subscription_package.create' ||
                            $current_route == 'admin.subscription_package.edit') active showMenu @endif">
                    <a href="javascript:void(0);">
                        <span class="icon fi fi-rr-folder-times"></span>
                        <div class="text">
                            <span>{{ get_phrase('Subscription Package') }}</span>
                        </div>
                    </a>
                    <ul class="first-sub-menu">
                        <li class="first-sub-menu-title fs-14px mb-18px">{{ get_phrase('Subscription Package') }}</li>
                        <li class="sidebar-second-li @if ($current_route == 'admin.subscription_package' || $current_route == 'admin.subscription_package.edit') active @endif">
                            <a
                                href="{{ route('admin.subscription_package') }}">{{ get_phrase('Manage Subscription Package') }}</a>
                        </li>
                        <li class="sidebar-second-li @if ($current_route == 'admin.subscription_package.create') active @endif">
                            <a
                                href="{{ route('admin.subscription_package.create') }}">{{ get_phrase('Add New Subscription') }}</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            @if (has_permission('admin.newsrooms') ||
                    has_permission('admin.newsroom.pending') ||
                    has_permission('admin.newsroom.category') ||
                    has_permission('admin.newsroom.category'))
                <li
                    class="sidebar-first-li first-li-have-sub {{ $current_route == 'admin.newsrooms' || $current_route == 'admin.newsroom.create' || $current_route == 'admin.newsroom.edit' || $current_route == 'admin.newsroom.pending' || $current_route == 'admin.newsroom.category' || $current_route == 'admin.newsroom.settings' ? 'active' : '' }}">
                    <a href="javascript:void(0);">
                        <span class="icon fi fi-rr-blog-text"></span>
                        <div class="text">
                            <span>{{ get_phrase('Newsrooms') }}</span>
                        </div>
                    </a>
                    <ul class="first-sub-menu">
                        <li class="first-sub-menu-title fs-14px mb-18px">{{ get_phrase('Newsrooms') }}</li>
                        @if (has_permission('admin.newsrooms'))
                            <li class="sidebar-second-li {{ $current_route == 'admin.newsrooms' ? 'active' : '' }}">
                                <a href="{{ route('admin.newsrooms') }}">{{ get_phrase('Manage Newsrooms') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.newsroom.pending'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.newsroom.pending' ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.newsroom.pending') }}">{{ get_phrase('Pending Newsrooms') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.newsroom.category'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.newsroom.category' ? 'active' : '' }}">
                                <a href="{{ route('admin.newsroom.category') }}">{{ get_phrase('Category') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.newsroom.settings'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.newsroom.settings' ? 'active' : '' }}">
                                <a href="{{ route('admin.newsroom.settings') }}">{{ get_phrase('Settings') }}</a>
                            </li>
                        @endif
                    </ul>
                </li>
            ...
            @if (has_permission('admin.learnings') ||
                    has_permission('admin.learning.pending') ||
                    has_permission('admin.learning.category') ||
                    has_permission('admin.learning.category'))
                <li
                    class="sidebar-first-li first-li-have-sub {{ $current_route == 'admin.learnings' || $current_route == 'admin.learning.create' || $current_route == 'admin.learning.edit' || $current_route == 'admin.learning.pending' || $current_route == 'admin.learning.category' || $current_route == 'admin.learning.settings' ? 'active' : '' }}">
                    <a href="javascript:void(0);">
                        <span class="icon fi fi-rr-blog-text"></span>
                        <div class="text">
                            <span>{{ get_phrase('Learning Resources') }}</span>
                        </div>
                    </a>
                    <ul class="first-sub-menu">
                        <li class="first-sub-menu-title fs-14px mb-18px">{{ get_phrase('learnings') }}</li>
                        @if (has_permission('admin.learnings'))
                            <li class="sidebar-second-li {{ $current_route == 'admin.learnings' ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.learnings') }}">{{ get_phrase('Manage Learning Resources') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.learning.pending'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.learning.pending' ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.learning.pending') }}">{{ get_phrase('Pending Learning Resources') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.learning.category'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.learning.category' ? 'active' : '' }}">
                                <a href="{{ route('admin.learning.category') }}">{{ get_phrase('Category') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.learning.settings'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.learning.settings' ? 'active' : '' }}">
                                <a href="{{ route('admin.learning.settings') }}">{{ get_phrase('Settings') }}</a>
                            </li>
                        @endif
                    </ul>
                </li>
    ...
    @if (has_permission('admin.system.settings') ||
            ...
            has_permission('admin.dynamic_pages.settings') ||
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="px-14px pb-24px mb-5 pb-5">
                <li
                    class="sidebar-first-li first-li-have-sub {{ $current_route == 'admin.system.settings' || $current_route == 'admin.website.settings' || $current_route == 'admin.dynamic_pages.settings' || $current_route == 'admin.language.phrase.edit' || $current_route == 'admin.payment.settings' || $current_route == 'admin.manage.language' || $current_route == 'admin.notification.settings' || $current_route == 'admin.live.class.settings' || $current_route == 'admin.live.class.settings' || $current_route == 'admin.certificate.settings' || $current_route == 'admin.player.settings' || $current_route == 'admin.open.ai.settings' || $current_route == 'admin.pages' || $current_route == 'admin.seo.settings' || $current_route == 'admin.about' ? 'active' : '' }}">
                    <a href="javascript:void(0);">
                    ...
                    <ul class="first-sub-menu">
                        ...
                        @endif
                        @if (has_permission('admin.dynamic_pages.settings'))
                            <li
                                class="sidebar-second-li {{ $current_route == 'admin.dynamic_pages.settings' ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.dynamic_pages.settings') }}">{{ get_phrase('Dynamic Pages Settings') }}</a>
                            </li>
                        @endif
