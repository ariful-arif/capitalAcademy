        ...
        <div class="sidebar-body">
            <div class="card border-0 m-2">
                <div class="card-body pt-0">
                    ...
                    <span class="badge bg-secondary rounded-1">{certificate_issue_date}</span>
                ...
                <div class="card-body pt-2">
                    ...
                    <form action="#">
                        <div class="mb-3">
                            ...
                            <textarea name="certificate_element_content" placeholder="Student name: {student_name}" id="certificate_element_content" rows="3" class="form-control"></textarea>
                        </div>
                        <div class="mb-3">
    ...
    <div id="certificate_builder_content" class="builder dotted-background">
        ...
        @if (get_settings('certificate_builder_content'))
            @php
                ...
                $htmlContent = $certificate_program->certificate_builder_content ?? $default_content;
                ...
                $newSrc = get_image($certificate_program->certificate_template);
        ...
        @else
            <div id="certificate-layout-module" class="certificate-layout-module resizeable-canvas draggable position-relative">
                <img class="certificate-template w-100 h-100" src="{{ $newSrc }}">
            </div>
        @endif
    </div>
    <script>
        ...
        function saveTemplate() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('admin.certificate_program_builder_update', ['id' => $certificate_program->id]) }}",
                data: {
                ...
                success: function(response) {
                    var successMessage = `<div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Success!</strong> Layout saved successfully.
