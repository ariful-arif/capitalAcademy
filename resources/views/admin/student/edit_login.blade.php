<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <input type="email" name="email" class="form-control ol-form-control" id="email" @isset($organization_users->email) value="{{ $organization_users->email }}" @endisset required>
    </div>
</div>

@if (!isset($organization_users->email))
    <div class="row mb-3">
