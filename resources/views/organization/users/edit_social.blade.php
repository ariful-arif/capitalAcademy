...
<div class="row mb-3">
    <label for="title" class="form-label ol-form-label col-sm-2 col-form-label">{{ get_phrase('Instagram') }}</label>
    <div class="col-sm-8">
        <input type="text" name="instagram" class="form-control ol-form-control" id="title" @isset($student->instagram) value="{{ $student->instagram }}" @endisset>
    </div>
</div>
