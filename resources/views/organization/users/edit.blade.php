...
@push('title', get_phrase('Update users'))
...
@section('content')
    ...
    <div class="ol-card p-4">
        ...
        <div class="ol-card-body">
            <form action="{{ route('organization.users.update', ['id' => $organization_users->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                    ...
                    <div class="tab-content w-100" id="myv-pills-tabContent">
                        ...
                        <button type="submit" class="btn ol-btn-primary mt-3">
                            <span>{{ get_phrase('Update User') }}</span>
                        </button>
                    </div>
                </div>
            </form>
