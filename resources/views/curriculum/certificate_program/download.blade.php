...
<head>
    ...
    <title>{{ $certificate_program->title }} | {{ get_phrase('Certificate') }}</title>
...
<body>
    ...
    <div class="captureCertificate" id="captureCertificate">
        @php
            ...
            $qr_code = $qrcode;
            $certificate_issue_date = date_formatter($result->created_at);
            $certificate_download_date = date('d M Y');

            $certificate_builder_content = $certificate_program->certificate_builder_content ?? $default_content;
            ...
            $certificate_builder_content = str_replace('{certificate_issue_date}', $certificate_issue_date, $certificate_builder_content);
