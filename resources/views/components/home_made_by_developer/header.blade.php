                    ...
                    <div class="nav-menu w-100">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100">
                            ...
                            <li class="pe-2 ps-5"><a href="{{ route('bootcamps') }}" class="@if ($current_route == 'bootcamps' || $current_route == 'bootcamp.details') active @endif">{{ get_phrase('Bootcamp') }}</a></li>
                             <li class="pe-2 ps-5"><a href="{{ route('course.bundles') }}" class="@if ($current_route == 'course.bundles') active @endif">{{ get_phrase('Course Bundles') }}</a></li>
        ...
        <div class="off-menu">
            ...
            <div class="mt-3 flex-shrink-0">
                <ul class="list-unstyled ps-0">
                    ...
                    <li><a href="{{ route('course.bundles') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3">{{ get_phrase('Course Bundles') }}</a></li>
