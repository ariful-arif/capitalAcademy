...
use App\Http\Controllers\DynamicPagesSettingController;
...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
    ...
    // newsrooms route
    Route::controller(NewsroomController::class)->group(function () {
        Route::get('newsrooms', 'index')->name('newsrooms');
        Route::get('newsroom/create', 'create')->name('newsroom.create');
        Route::post('newsroom/store', 'store')->name('newsroom.store');
        Route::get('newsroom/edit/{id}', 'edit')->name('newsroom.edit');
        Route::get('newsroom/delete/{id}', 'delete')->name('newsroom.delete');
        Route::post('newsroom/update/{id}', 'update')->name('newsroom.update');
        Route::get('newsroom/status/{id}', 'status')->name('newsroom.status');

        Route::get('newsroom/pending', 'pending')->name('newsroom.pending');
        Route::get('newsroom/settings', 'settings')->name('newsroom.settings');
        Route::post('newsroom/settings/update', 'update_settings')->name('newsroom.settings.update');
    });

    // Newsroom categories route
    Route::controller(NewsroomCategoryController::class)->group(function () {
        Route::get('newsroom/category', 'index')->name('newsroom.category');
        Route::post('newsroom/category/create', 'create')->name('newsroom.category.create');
        Route::post('newsroom/category/store', 'store')->name('newsroom.category.store');
        Route::get('newsroom/category/delete/{id}', 'delete')->name('newsroom.category.delete');
        Route::post('newsroom/category/update/{id}', 'update')->name('newsroom.category.update');
    });

    // learnings route
    Route::controller(LearningController::class)->group(function () {
        Route::get('learnings', 'index')->name('learnings');
        Route::get('learning/create', 'create')->name('learning.create');
        Route::post('learning/store', 'store')->name('learning.store');
        Route::get('learning/edit/{id}', 'edit')->name('learning.edit');
        Route::get('learning/delete/{id}', 'delete')->name('learning.delete');
        Route::post('learning/update/{id}', 'update')->name('learning.update');
        Route::get('learning/status/{id}', 'status')->name('learning.status');

        Route::get('learning/pending', 'pending')->name('learning.pending');
        Route::get('learning/settings', 'settings')->name('learning.settings');
        Route::post('learning/settings/update', 'update_settings')->name('learning.settings.update');
    });

    // learning categories route
    Route::controller(LearningCategoryController::class)->group(function () {
        Route::get('learning/category', 'index')->name('learning.category');
        Route::post('learning/category/create', 'create')->name('learning.category.create');
        Route::post('learning/category/store', 'store')->name('learning.category.store');
        Route::get('learning/category/delete/{id}', 'delete')->name('learning.category.delete');
        Route::post('learning/category/update/{id}', 'update')->name('learning.category.update');
    });
    ...
    Route::controller(DynamicPagesSettingController::class)->group(function () {

        //dynamic pages settings
        Route::get('dynamic_pages_settings', 'dynamic_pages_settings')->name('dynamic_pages.settings');
        Route::post('dynamic_pages_settings/update', 'dynamic_pages_settings_update')->name('dynamic_pages.settings.update');
    ...
    Route::controller(CertificateController::class)->group(function () {
        Route::get('certificate_program', 'certificate_program')->name('certificate_program');
        Route::get('certificate_program/create', 'create')->name('certificate_program.create');
        Route::post('certificate_program/store', 'store')->name('certificate_program.store');
        Route::get('certificate_program/edit/{id}', 'edit')->name('certificate_program.edit');
    ...
    Route::controller(SubscriptionPackageController::class)->group(function () {
        Route::get('subscription_package', 'subscription_package')->name('subscription_package');
        Route::get('subscription_package/create', 'create')->name('subscription_package.create');
        Route::post('subscription_package/store', 'store')->name('subscription_package.store');
        Route::get('subscription_package/edit/{id}', 'edit')->name('subscription_package.edit');
        Route::post('subscription_package/update/{id}', 'update')->name('subscription_package.update');
        Route::get('subscription_package/delete/{id}', 'delete')
